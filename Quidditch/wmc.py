...
@app.route('/home/user-events/price')
def price():
    return render_template('price.html', public_key=public_key)
...
@app.route('/home/user-events/price/payment', methods=['POST'])
def payment():
    ...
    body =  f'Payment Receipt \n\n'+f'Thank you for your donation of 19.99 USD.\n\n' +f'Payment Details:\n' +f'Payment Amount: {charge.amount / 100:.2f} USD\n' +f'Payment Method: {charge.source.brand} {charge.source.last4}\n' +f'Receipt ID: {charge.receipt_number}'
    send_email(to_address=customer.email,subject=subject,body=body)
